...
N_JOBS_MAX_EXIT=4 # max number of jobs allowed to run simutaneously for previously failed jobs
SUBMIT_COUNT_MAX=3 # max number of times a job can be submitted to the cluster
BATCH_SIZE_EXIT=16 # use a smaller batch size for previously failed jobs
